...
**Last updated:** 2026-06-20. **All items below are ✅ done** — see the companion
[fix-plan](data-architecture-fix-plan.md) for per-phase acceptance and migration IDs.
This backlog is kept for the finding→remediation mapping; the fix-plan is the
