// Circle-bounded, thin-stroke brand + contact glyphs (64×64, currentColor).
// Shared by the Footer and the Contacts page so the two stay in sync. Each takes
// a `className` so the consumer controls sizing; all inherit `currentColor`, so
// they tint to the accent on hover automatically.
...
export function VkIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox='0 0 64 64' fill='none' stroke='currentColor' aria-hidden>
