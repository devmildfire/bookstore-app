...
const thirdPar =
  'Вы можете вложить в Чтиво любую сумму от 30 000₽. Ваши деньги пойдут на выпуск новых печатных изданий, оплату труда специалистов и расширение охвата Чтива. Наши инвесторы получают деньги назад с процентом, а также:';
const fourthPar =
  'Возможно спонсорство с указанием бренда спонсора в издании и сопутствующих материалах.';

const fifthPar =
  'Чтобы узнать больше и участвовать, пишите нам на info@chtivo.spb.ru';
