...
const thirdPar =
  'Вы можете вложить в Чтиво любую сумму от 30 000 ₽. Ваши деньги пойдут на выпуск новых печатных изданий, оплату труда специалистов и расширение охвата Чтива. Вы получаете деньги назад с процентом, а также:';
const fourthPar =
