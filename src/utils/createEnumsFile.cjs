...
var getAllEnums = function () { return __awaiter(void 0, void 0, void 0, function () {
    var data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, supabase.rpc('get_enums')];
            case 1:
                data = (_a.sent()).data;
                if (data) {
...
var printEnums = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                enums = _a.sent();
                cutEnums = enums === null || enums === void 0 ? void 0 : enums.filter(function (item) { return item.enum_schema === 'public'; });
                aggregatedEnums = {};
                cutEnums === null || cutEnums === void 0 ? void 0 : cutEnums.forEach(function (item) {
