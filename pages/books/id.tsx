        ...
        <div className='author'>
          ...
          <div className='authorContacts'>
            ...
            <ul className='contactsList'>
              ...
              <a href='http://instagram.com' className='contactLink' target='_blank' rel='noreferrer'>
                <li className='contactsItem contactsItem-instagram'>
                  <Icon src='../../public/images/instagram.svg' />
                </li>
              </a>
              <a href='http://facebook.com' className='contactLink' target='_blank' rel='noreferrer'>
