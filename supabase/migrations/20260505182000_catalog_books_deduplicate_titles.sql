-- Catalog discovery is title-oriented. Product variants remain available on
-- title detail pages, but catalog/search/latest grids should show each title once.
