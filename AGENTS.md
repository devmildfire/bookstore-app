...
| Document | Covers |
|----------|--------|
| [docs/conventions/CODE_STYLE.md](docs/conventions/CODE_STYLE.md) | Formatting, naming, component design, React/Next.js rules, Server vs Client |
...
| [docs/conventions/COMPONENTS.md](docs/conventions/COMPONENTS.md) | Component structure, Server vs Client, Radix UI, forms, layouts |
| [docs/conventions/DATA.md](docs/conventions/DATA.md) | TanStack Query, Supabase, data fetching, Server Actions, entity layer |
...
| [docs/conventions/ERROR_HANDLING.md](docs/conventions/ERROR_HANDLING.md) | Error boundaries, Server Actions, TanStack Query errors, loading/not-found |
